...
YAHOO.widget.MenuManager = new function() {
    ...
    * to be added.
    */
	// [ehalvorsen] modified to make menues work across frames
    this.addMenu = function(p_oMenu) {
        if(p_oMenu && p_oMenu.id && !m_oMenus[p_oMenu.id]) {
            m_oMenus[p_oMenu.id] = p_oMenu;
            var oDoc = this.oDoc || document; 

            if(!m_bInitializedEventHandlers || !oDoc.YAHOO_widget_MenuManager_InitializedEventHandlers) {
				...
				oDoc.YAHOO_widget_MenuManager_InitializedEventHandlers = true;
            }
