...
public class PaletteRootCreator extends PaletteRoot {
	...
	public PaletteRootCreator(IProject project) {
		...
		tool = new ConnectionCreationToolEntry(
				"Connection",
				"Create a new Connection or User Interaction. Drag and drop from source page to target page",
		...
		tool = new CombinedTemplateCreationEntry("Button",
				"Check for a button on the page (also image input button). For non-input <button> elements, use Contexts.", Button.class,
